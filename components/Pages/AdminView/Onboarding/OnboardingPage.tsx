    ...
    <main className="mx-auto max-w-lg p-6">
      ...
      <form
        ...
        onSubmit={async (e) => {
          ...
          if (!parsed.success) {
            setErr(
              "Please enter a valid store name, location, and WhatsApp number (digits only, no leading zero).",
            );
            return;
          }
          ...
          try {
            ...
            const fullNumber =
              countryCode.replace("+", "") + parsed.data.whatsapp_number;
      ...
      >
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            This will be shown to customers on your store.
          </p>
        </div>
